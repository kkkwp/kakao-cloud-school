...
const getAverage = (numbers) => {
    ...
    // 매개변수는 2개 - 첫번째 매개변수는 수행할 함수이고 두번째 매개변수는 연산을 시작할 때의 초기값

    // 첫번째 매개변수인 함수는 매개변수를 4개까지 가지는데
    // 1.누적값 2.배열의 요소, 3.배열의 인덱스, 4.배열
...
const Average = () => {
    ...
    // list에 변화가 생긴 경우에만 메서드를 호출하고 그 이외의 경우는 결과를 재사용
