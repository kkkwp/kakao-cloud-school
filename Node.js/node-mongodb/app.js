...
app.get('/item/paging', (req, res) => {
    ...
    // 웹에서 클라이언트가 정송하는 데이터는 기본적으로 무조건 문자열
    // 계산할 때에는 숫자로 변형을 해서 계산해야 한다.
...
// 결과는 하나의 데이터를 리턴하는 경우가 많지만, 주위의 3-10여개의 데이터를 같이 리턴하는 경우도 많음
